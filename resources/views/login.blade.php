                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left p-5">
                            <div class="brand-logo" style="text-align-center">
                                <img src="purple/assets/images/logo-ppkd.png">
                            </div>

                            <h4>Welcome to PPKD-JP 's Web !</h4>
                            <h6 class="font-weight-light">Sign in to continue.</h6>

                            <form class="pt-3" action="{{route('login.function')}}" method="post">
                                @csrf
                                ...
                                <div class="mt-3">
                                    <button type="submit"
                                        class="btn btn-block btn-inverse-primary btn-lg font-weight-medium auth-form-btn">SIGN
                                        IN</button>
                                </div>
                                ...
                                <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href=""
